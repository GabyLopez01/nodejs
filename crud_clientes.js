...
crud_cliente.cud=(req,res) => {
    ...
    if(btn_crear){
        ...
        {nit:nit,nombres:nombres,apellidos:apellidos,direccion:direccion,telefono:telefono,fecha_nacimiento:fecha_nacimiento},(error,results)=>{
                if(error){
                    console.log(error);
                }else{
                    res.redirect('/')
    ...
    if(btn_actualizar){
        ...
        [{nit:nit,nombres:nombres,apellidos:apellidos,direccion:direccion,telefono:telefono,fecha_nacimiento:fecha_nacimiento},id_cliente],(error,results)=>{
                if(error){
                    console.log(error);
                }else{
                    res.redirect('/')
